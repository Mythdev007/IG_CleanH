...
class InvoiceStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'invoices.status.show';

    protected $editRoute = 'invoices.status.edit';
     ...
     */
    public function query(InvoiceStatus $model)
    {
