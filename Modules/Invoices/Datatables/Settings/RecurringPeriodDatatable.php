...
namespace Modules\Invoices\Datatables\Settings;
...
class RecurringPeriodDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'invoices.recurring-period.show';

    protected $editRoute = 'invoices.recurring-period.edit';
     ...
     */
    public function query(InvoiceRecurringPeriod $model)
    {
