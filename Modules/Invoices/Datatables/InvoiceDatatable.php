...
class InvoiceDatatable extends PlatformDataTable
{
    ...
    public static function availableQueryFilters()
    {
        return [
            ...
            [
                'id' => 'invoices.recurring_period_id',
                ...
                'values' => InvoiceRecurringPeriod::pluck('name', 'id'),
                'operators' => [
                    'in',
                    'not_in',
                    'is_null',
    ...
    public static function availableColumns()
    {
        return [
            ...
            'is_recurring' => [
                'data' => 'is_recurring',
                'title' => trans('invoices::invoices.form.is_recurring'),
                'data_type' => 'boolean',
                'filter_type' => 'text'
            ],
            'discount' => [
            ...
            'invoices_dict_recurring_period' => [
                'name' => 'invoices_dict_recurring_period.name',
                'data' => 'status',
                'title' => trans('invoices::invoices.form.recurring_period_id'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->filterColumn('is_recurring', function ($query, $keyword) {

            if ($keyword == 'yes') {
                $query->where('invoices.is_recurring', 1);
            } else {
                $query->where('invoices.is_recurring', 0);
            }
    ...
    public function query(Invoice $model)
    {
        ...
        $query = $model->newQuery()
            ...
            ->leftJoin('invoices_dict_recurring_period', 'invoices.recurring_period_id', '=', 'invoices_dict_recurring_period.id')
            ...
            ->select(
                ...
                'invoices_dict_recurring_period.name as recurring_period',
