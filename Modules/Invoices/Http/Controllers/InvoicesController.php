...
class InvoicesController extends ModuleCrudController
{
    ...
    protected $moduleSettingsLinks = [
        ['route' => 'invoices.settings.show', 'label' => 'settings.settings'],
        ['route' => 'invoices.status.index', 'label' => 'settings.status'],
        ['route' => 'invoices.recurring-period.index', 'label' => 'settings.recurring_period'],
    ...
    protected $sectionButtons = [
        ...
        [
            ...
            'class' => 'btn normal-text btn-primary btn-xs',
            'id' => 'invoice-add-row',
            'href' => '#',
            'label' => 'form.add_row',
            'icon' => '',
    ...
    protected $showFields = [
        ...
        'recurring' => [
            ...
            'recurring_period_id' => [
                'col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6',
                'type' => 'manyToOne', 'relation' => 'recurringPeriod', 'column' => 'name'
            ],
        ],
    ...
    public function store()
    {
        ...
        $this->invoiceService->updateInvoiceIterator();
