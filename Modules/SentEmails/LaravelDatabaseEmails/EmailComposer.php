...
class EmailComposer
{
    ...
    public function composedById($userId)
    {
        return $this->setData('composed_by_id', $userId);
    }

    public function campaignId($camapignId)
    {
        return $this->setData('campaign_id', $camapignId);
    }

    public function emailCampaignId($emailCampaignId)
    {
        return $this->setData('email_campaign_id', $emailCampaignId);
    }
