...
class AssetManufacturerDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'assets.manufacturer.show';

    protected $editRoute =  'assets.manufacturer.edit';
    /**
     ...
     */
    public function query(AssetManufacturer $model)
    {
