...
class AssetCategoryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'assets.category.show';

    protected $editRoute =  'assets.category.edit';
     ...
     */
    public function query(AssetCategory $model)
    {
