...
class AssetsDemoSeederTableSeeder extends SeederHelper
{
    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 50; $i++) {
            ...
            $asset->asset_status_id  = AssetStatus::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
            $asset->asset_category_id = AssetCategory::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
            $asset->asset_manufacturer_id = AssetManufacturer::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
        ...
        for ($i = 51; $i <= 100; $i++) {
            ...
            $asset->asset_status_id  = AssetStatus::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
            $asset->asset_category_id = AssetCategory::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
            $asset->asset_manufacturer_id = AssetManufacturer::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
