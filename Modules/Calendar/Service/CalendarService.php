    ...
    public function fullCalendarInstance(Calendar $calendar = null, $customSettings = [])
    {
        ...
        $settings =  [
            ...
            'select' => new JsExpression('function(start,end,jsEvent,view){
                     VAANCE_Calendar.calendarEventSelect(start,end,jsEvent,view);
                }'),

            'eventDrop' => new JsExpression('function(event,delta,revertFunc){
                    VAANCE_Calendar.calendarEventDrop(event,delta,revertFunc);
                }'),
            'eventClick' => new JsExpression('function(calEvent,jsEvent,view){
                     VAANCE_Calendar.calendarEventClick(calEvent,jsEvent,view);
                }'),
            'eventResize' => new JsExpression('function(event,delta,revertFunction){
                    VAANCE_Calendar.calendarEventResize(event,delta,revertFunction);
                }')
