...
@push('scripts')
                ...
                <script>
                    window.EVENT_CREATE_URL = "{!!  route('calendar.events.create',['mode'=>'modal','calendar_id' => $userCalendar->id,'afterAction' => 'refreshCalendar'])  !!}";
                </script>
                ...
                <script src="{!! Module::asset('calendar:js/VAANCE_Calendar.js') !!}"></script>
