...
class EventStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'calendar.status.show';

    protected $editRoute =  'calendar.status.edit';
     ...
     */
    public function query(EventStatus $model)
    {
