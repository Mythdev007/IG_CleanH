...
namespace Modules\Calendar\Datatables\Settings;
...
class EventPriorityDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'calendar.priority.show';


    protected $editRoute = 'calendar.priority.edit';
     ...
     */
    public function query(EventPriority $model)
    {
