...
class CalendarDemoSeederTableSeeder extends SeederHelper
{
    private function generatePrivateEvents()
    {
        ...
        for ($i = 1; $i <= 4;$i++) {
            ...
            $event->event_priority_id = EventPriority::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
            $event->event_status_id = EventStatus::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
        ...
        for ($i = 1; $i <= 4;$i++) {
            ...
            $event->event_priority_id = EventPriority::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
            $event->event_status_id = EventStatus::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
