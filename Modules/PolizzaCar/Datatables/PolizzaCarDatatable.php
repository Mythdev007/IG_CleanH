...
namespace Modules\PolizzaCar\Datatables;
...
class PolizzaCarDatatable extends PlatformDataTable
{
    ...
    public static function availableColumns()
    {
        return [
            ...
            'company_vat' => [
                'data' => 'company_vat',
                'title' => trans('PolizzaCar::PolizzaCar.form.company_vat'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
            'works_place_city' => [
                'name' => 'polizza_car_procurement.name',
                'data' => 'works_place_city',
                'title' => trans('PolizzaCar::PolizzaCar.form.works_place_city'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
            'numero_polizza' => [
