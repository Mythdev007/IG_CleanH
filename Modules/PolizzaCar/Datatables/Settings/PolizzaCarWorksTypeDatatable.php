...
class PolizzaCarWorksTypeDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'polizzacar.works_type.show';

    protected $editRoute = 'polizzacar.works_type.edit';
     ...
     */
    public function query(PolizzaCarWorksType $model)
    {
