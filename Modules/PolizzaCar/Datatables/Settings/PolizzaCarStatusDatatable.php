...
class PolizzaCarStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'polizzacar.status.show';

    protected $editRoute = 'polizzacar.status.edit';
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->editColumn('status', function ($record) {
            $text = "<span class='badge badge-default col-$record->color'>$record->status</span>
     ...
     */
    public function query(PolizzaCarStatus $model)
    {
    ...
    protected function getColumns()
    {
        return
            ...
            [
                ...
                'image' => [
                    'data' => 'image',
                    'title' => trans('core::core.table.image'),
                    'data_type' => 'image',
                    'filter_type' => 'text'
                ],
                'color' => [
