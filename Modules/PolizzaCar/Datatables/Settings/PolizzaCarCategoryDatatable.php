...
class PolizzaCarCategoryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'polizzacar.category.show';

    protected $editRoute = 'polizzacar.category.edit';
     ...
     */
    public function query(PolizzaCarCategory $model)
    {
