 ...
 */
class LeadSourceDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'leads.source.show';

    protected $editRoute = 'leads.source.edit';
     ...
     */
    public function query(LeadSource $model)
    {
