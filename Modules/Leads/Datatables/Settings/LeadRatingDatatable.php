...
/**
 * Class LeadRatingDatatable
 * @package Modules\Leads\Datatables\Settings
 */
class LeadRatingDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'leads.rating.show';

    protected $editRoute = 'leads.rating.edit';
     ...
     */
    public function query(LeadRating $model)
    {
