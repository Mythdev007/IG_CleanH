...
class LeadsDatatable extends PlatformDataTable
{
    ...
    public static function availableQueryFilters()
    {
        return [
            ...
            [
                'id' => 'leads.birth_date',
                'label' => trans('leads::leads.form.birth_date'),
                'type' => 'date',
                'input_event' => 'dp.change',
                'plugin' => 'datetimepicker',
                'plugin_config' => [
            ...
            [
                'id' => 'leads.addr_country_id',
                'label' => trans('leads::leads.form.addr_country_id'),
                'type' => 'integer',
                'input' => 'select',
                'multiple' => true,
                'plugin' => 'select2',
            ...
            [
                ...
                'label' => trans('leads::leads.form.continent'),
                'type' => 'string',
                'input' => 'select',
                'multiple' => true,
                'plugin' => 'select2',
            ...
            [
                'id' => 'leads.language_id',
                'label' => trans('leads::leads.form.language_id'),
                'type' => 'integer',
                'input' => 'select',
                'multiple' => true,
                'plugin' => 'select2',
    ...
    public static function availableColumns()
    {
        return
            [
                ...
                'birth_date' => [
                    'data' => 'birth_date',
                    'title' => trans('leads::leads.form.birth_date'),
                    'data_type' => 'date',
                    'filter_type' => 'vaance_date_range_picker'
                ],
                'source' => [
                ...
                'language' => [
                    ...
                    'data' => 'language',
                    'title' => trans('leads::leads.form.language'),
                    'data_type' => 'text',
                    'filter_type' => 'text'
                ],
                'addr_street' => [
                ...
                'addr_country' => [
                    ...
                    'title' => trans('leads::leads.form.addr_country_id'),
                    'data_type' => 'text',
                    'filter_type' => 'text'
                ],
                'addr_city' => [
    ...
    public function query(Lead $model)
    {
        ...
        $query = $model->newQuery()
            ...
            ->select(
                ...
                'leads_dict_status.color as status_color',
