...
Route::group(['middleware' => ['web','permission:leads.browse'],'prefix'=>'leads','as'=>'leads.', 'namespace' => 'Modules\Leads\Http\Controllers'], function () {
    ...
    Route::post('leads/mass_update', ['as'=>'leads.mass_update','uses'=> 'LeadsController@massUpdate']);
    ...
    Route::get('leads/sentemails-selection/{entityId}', ['as'=>'sentemails.selection','uses'=> 'Tabs\LeadSentEmailsController@selection']);
    Route::get('leads/sentemails-linked/{entityId}', ['as'=>'sentemails.linked','uses'=> 'Tabs\LeadSentEmailsController@linked']);
    Route::post('leads/sentemails-unlink', ['as'=>'sentemails.unlink','uses'=> 'Tabs\LeadSentEmailsController@unlink']);
    Route::post('leads/sentemails-delete', ['as'=>'sentemails.delete','uses'=> 'Tabs\LeadSentEmailsController@delete']);
    Route::post('leads/sentemails-link', ['as'=>'sentemails.link','uses'=> 'Tabs\LeadSentEmailsController@link']);
