...
class LeadsController extends ModuleCrudController
{
    ...
    protected $relationTabs = [
        ...
        'lead_sent_emails' => [
            ...
            'datatable' => [
                'datatable' => LeadSentEmailsDatatable::class
            ],
            'route' => [
                'linked' => 'leads.sentemails.linked',
                'create' => 'sentemails.sentemails.create',
                'select' => 'leads.sentemails.selection',
                'bind_selected' => 'leads.sentemails.link'
            ],
            'create' => [
                'allow' => true,
    ...
    protected $showFields = [
        ...
        'address_information' => [
            'addr_street' => ['type' => 'text','col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6'],
            'addr_city' => ['type' => 'text', 'col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6'],
            'addr_zip' => ['type' => 'text', 'col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6'],
            'addr_state' => ['type' => 'text', 'col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6'],
            'addr_country_id' => [
                'type' => 'manyToOne',
                'relation' => 'addrCountry',
                'column' => 'name',
                'col-class' => 'col-lg-4 col-md-4 col-sm-6 col-xs-6'
            ],
        ],
