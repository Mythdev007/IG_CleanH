...
class UsersAddForeignKeys extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->foreign('time_format_id')->references('id')->on('vaance_time_format');

            $table->integer('date_format_id')->unsigned()->nullable()->change();
            $table->foreign('date_format_id')->references('id')->on('vaance_date_format');

            $table->integer('language_id')->unsigned()->nullable()->change();
            $table->foreign('language_id')->references('id')->on('vaance_language');
        });
