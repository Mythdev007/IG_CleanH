...
class AnnouncementController extends AppBaseController
{
    ...
    public function saveAnnouncement(SaveAnnouncementRequest $request)
    {
        ...
        Settings::set(SettingsHelper::S_ANNOUNCEMENT_MESSAGE, $request->get($form->getField('message')->getName()));
        Settings::set(SettingsHelper::S_ANNOUNCEMENT_DISPLAY_CLASS, $request->get($form->getField('display_class')->getName()));
