                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <a target="_blank" href="/vaance/pages/ui/icons.html"> @lang('menumanager::menu_manager.icon_ref')</a>
                            </div>
                        </div>
...
@push('css')
    <link href="{{ asset('vaance/plugins/nestable/jquery-nestable.css') }}" rel="stylesheet" type="text/css">
@endpush
@push('scripts')
    <script src="{{ asset('vaance/plugins/nestable/jquery.nestable.js')}}"></script>
    <script src="{!! Module::asset('menumanager:js/VAANCE_MenuManager.js') !!}"></script>
