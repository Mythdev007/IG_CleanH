/**
 *
 * @type {{init: VAANCE_MenuManager.init, initEdit: VAANCE_MenuManager.initEdit, populateValues: VAANCE_MenuManager.populateValues, initMenuManager: VAANCE_MenuManager.initMenuManager}}
 */
var VAANCE_MenuManager = {
                ...
                if (id != null && id > 0) {
                    $.ajax({
                        ...
                        success: function (result) {
                            VAANCE_Common.showNotification(result.color, result.message);
            ...
            if (id != null && id > 0) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        VAANCE_MenuManager.populateValues('#save_menu_element_form', result.menu_element);
