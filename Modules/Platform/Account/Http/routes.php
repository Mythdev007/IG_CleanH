...
Route::group(['middleware' => 'web', 'prefix' => 'account', 'namespace' => 'Modules\Platform\Account\Http\Controllers'], function () {
    ...
    Route::post('mail-settings', ['as'=>'account.mail_settings','uses'=>'AccountController@mailSettings']);

    Route::post('send-test-email', ['as'=>'account.send_test_email','uses'=>'SendMailTestController@send']);

    Route::get('generate-api-key', ['as'=>'account.generate_api_key','uses'=>'AccountController@generateApiKey']);
