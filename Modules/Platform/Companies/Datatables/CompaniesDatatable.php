...
class CompaniesDatatable extends PlatformDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->filterColumn('created_at', function ($query, $keyword) {
            ...
            if ($dates != null) {
                $query->whereBetween('vaance_companies.created_at', array($dates[0], $dates[1]));
            }
        });
        ...
        $dataTable->filterColumn('subscription_valid_until', function ($query, $keyword) {
            ...
            if ($dates != null) {
                $query->whereBetween('vaance_companies.subscription_valid_until', array($dates[0], $dates[1]));
            }
        });
        ...
        $dataTable->filterColumn('updated_at', function ($query, $keyword) {
            ...
            if ($dates != null) {
                $query->whereBetween('vaance_companies.updated_at', array($dates[0], $dates[1]));
            }
        });
    ...
    public function query(Company $model)
    {
        return $model->newQuery()
            ->leftJoin('vaance_companies_plan', 'vaance_companies.plan_id', '=', 'vaance_companies_plan.id')
            ->select(
                'vaance_companies.*',
                'vaance_companies_plan.name as company_plan'
            );
    }
    ...
    protected function getColumns()
    {
        return
            ...
            [
                ...
                'plan' => [
                    'data' => 'company_plan',
                    'name' => 'vaance_companies_plan.name',
                ...
                'subscription_valid_until' => ['data' => 'subscription_valid_until', 'title' => trans('companies::companies.table.subscription_valid_until'), 'data_type' => 'date', 'filter_type' => 'vaance_date_range_picker',],
                'created_at' => ['data' => 'created_at', 'title' => trans('companies::companies.table.created_at'), 'data_type' => 'datetime', 'filter_type' => 'vaance_date_range_picker',],
                'updated_at' => ['data' => 'updated_at', 'title' => trans('companies::companies.table.updated_at'), 'data_type' => 'datetime', 'filter_type' => 'vaance_date_range_picker',]
            ];
    }
}
