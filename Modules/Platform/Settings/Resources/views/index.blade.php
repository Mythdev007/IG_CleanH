                        ...
                        @if($company != null )
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="info-box">
                                    ...
                                    <div class="content">
                                        <div class="text">@lang('settings::settings.cron_last_run')</div>
                                        <div class="number">
                                            @if($cron_last_run)
                                                {{ \Modules\Platform\Core\Helper\UserHelper::formatUserDateTime($cron_last_run) }}
                                            @else

                                                @lang('settings::settings.cron_not_set')
