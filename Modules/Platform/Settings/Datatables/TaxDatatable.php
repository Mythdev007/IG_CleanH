 ...
 */
class TaxDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'settings.tax.show';
    ...
    protected function getColumns()
    {
        return
            ...
            [
                'name' => [
                    'data' => 'name',
                    'title' => trans('settings::tax.table.name'),
                    'data_type' => 'text',
                    'filter_type' => 'text'
                ],
                'tax_value' => [
                    'data' => 'tax_value',
                    'title' => trans('settings::tax.table.tax_value'),
                    'data_type' => 'text',
                    'filter_type' => 'text'
                ],
                'created_at' => [
                    'data' => 'created_at',
                    'title' => trans('settings::tax.table.created_at'),
                    'data_type' => 'datetime',
                    'filter_type' => 'vaance_date_range_picker',
                ],
                'updated_at' => [
                    'data' => 'updated_at',
                    'title' => trans('settings::tax.table.updated_at'),
                    'data_type' => 'datetime',
                    'filter_type' => 'vaance_date_range_picker',
                ]
            ];
