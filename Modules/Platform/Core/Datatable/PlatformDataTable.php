...
abstract class PlatformDataTable extends DataTable
{
    ...
    const TABLE_MODE_NORMAL = 'normal';
    const TABLE_MODE_MODAL = 'modal';
    ...
    public $tableMode = self::TABLE_MODE_NORMAL;

    public $relationMode = false;

    protected $additionalValues = [];

    protected $additionalTableClass;
     ...
     * @param $class
     */
    public function setAdditionalTableClass($class){
        $this->additionalTableClass = $class;
    }
    ...
    protected $excludeFromExport = [
        'quick_edit','check_select','unlink'
    ];
