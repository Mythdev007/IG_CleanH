                    ...
                    <div class="header">
                        <h2>
                            ...
                            <div class="header-buttons">
                                <a href="{{ route($routes['show'],$entity) }}" class="btn btn-primary btn-back btn-crud">@lang('core::core.crud.back')</a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            @foreach($show_fields as $panelName => $panel)
                                ...
                                @foreach($panel as $fieldName => $options)
                                    ...
                                    @if(!isset($options['hide_in_form']) && !isset($options['hide_in_edit']) )
