            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        @if($showMassActionButtons && isset($massActionButtons)  && Auth::user()->hasPermissionTo($permissions['destroy']) )
                            <div id="index-mass-action" class="pull-left btn-mass-action" style="display: none;">
                                ...
                                <ul class="dropdown-menu">
                                    @foreach($massActionButtons as $actionButton)
                                        <li>{{ Html::link($actionButton['href'],$actionButton['label'],$actionButton['attr']) }}</li>
                                    @endforeach
                                </ul>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist" style=" margin-bottom: 10px">
                                @foreach($indexTabButtons as $tab)
                                    <li role="presentation" class="{{ isset($tab['default']) ? "active" : '' }}">{{ Html::link($tab['href'],$tab['label'],$tab['attr']) }}</li>
                        ...
                        <div data-create-route="{{ route($routes['create'],['mode'=>'modal']) }}" id="modal_quick_create" class="modal fade" role="dialog">
                            ...
                            <div data-create-route="{{ route($routes['create'],['mode'=>'modal','action'=>'mass_update']) }}" id="modal_mass_update" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>

                                            <h4 class="modal-title">@lang($language_file.'.module') - @lang('core::core.crud.mass_update')</h4>
