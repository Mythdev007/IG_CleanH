...
class SettingsHelper
{
    const S_SUBSCRIPTION_INVOICE_FORM = 's_subscription_invoice_from';
    const S_SUBSCRIPTION_TERMS_AND_COND = 's_subscription_terms_and_cond';
    const S_SUBSCRIPTION_NOTES = 's_subscription_notes';
     ...
     * @return array
     */
    public static function companySettings($asString = false, $glue = "\n")
