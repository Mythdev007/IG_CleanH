...
abstract class CrudApiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->respond(true,[$result->paginate($perPage)],[],['message' =>  trans('core::core.entity.records_found')]);
    }
    ...
    public function store()
    {
        ...
        $entity = $repository->createEntity($request->only($entityClass->getFillable()), \App::make($this->entityClass));
    ...
    public function destroy($identifier)
    {
        ...
        return $this->respond(true, [], [], ['message' => trans('core::core.entity.deleted')]);
