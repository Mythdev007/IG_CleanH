...
namespace Modules\Calls\Datatables\Settings;
...
class DirectionTypeDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'calls.directiontype.show';

    protected $editRoute = 'calls.directiontype.edit';
     ...
     */
    public function query(DirectionType $model)
    {
