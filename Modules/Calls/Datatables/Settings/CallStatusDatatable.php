...
class CallStatusDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'calls.status.show';

    protected $editRoute = 'calls.status.edit';
     ...
     */
    public function query(CallStatus $model)
    {
