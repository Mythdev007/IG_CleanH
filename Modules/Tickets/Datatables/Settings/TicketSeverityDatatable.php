...
namespace Modules\Tickets\Datatables\Settings;
...
class TicketSeverityDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'tickets.severity.show';

    protected $editRoute = 'tickets.severity.edit';
     ...
     */
    public function query(TicketSeverity $model)
    {
