...
namespace Modules\ServiceContracts\Datatables\Tabs;
...
/**
 * Class ServiceContractsDocumentsDatatable
 * @package Modules\ServiceContracts\Datatables\Tabs
 */
class ServiceContractsDocumentsDatatable extends RelationDataTable
{
    const SHOW_URL_ROUTE = 'documents.documents.show';

    protected $unlinkRoute = 'servicecontracts.documents.unlink';
