...
namespace Modules\ServiceContracts\Datatables\Settings;
...
class ServiceContractPriorityDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'servicecontracts.priority.show';

    protected $editRoute = 'servicecontracts.priority.edit';
     ...
     */
    public function query(ServiceContractPriority $model)
    {
