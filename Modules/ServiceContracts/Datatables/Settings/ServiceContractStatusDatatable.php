...
class ServiceContractStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'servicecontracts.status.show';

    protected $editRoute = 'servicecontracts.status.edit';
     ...
     */
    public function query(ServiceContractStatus $model)
    {
