...
class ContactRequestStatusDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'contactrequests.contactrequeststatus.show';

    protected $editRoute = 'contactrequests.contactrequeststatus.edit';
     ...
     */
    public function query(ContactRequestStatus $model)
    {
