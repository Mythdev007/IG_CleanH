...
class ContactReasonDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'contactrequests.contactreason.show';

    protected $editRoute =  'contactrequests.contactreason.edit';
     ...
     */
    public function query(ContactReason $model)
    {
