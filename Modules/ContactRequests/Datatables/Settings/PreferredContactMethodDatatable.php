...
namespace Modules\ContactRequests\Datatables\Settings;
...
class PreferredContactMethodDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'contactrequests.preferredcontactmethod.show';

    protected $editRoute = 'contactrequests.preferredcontactmethod.edit';
     ...
     */
    public function query(PreferredContactMethod $model)
    {
