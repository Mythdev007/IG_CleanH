...
use Modules\Campaigns\Datatables\Tabs\CampaignsSentEmailsDatatable;
...
class CampaignsController extends ModuleCrudController
{
    ...
    protected $relationTabs = [
        ...
        'campaign_sent_emails' => [
            ...
            'datatable' => [
                'datatable' => EmailCampaignDatatable::class
            ],
            'route' => [
                'linked' => 'campaigns.emailcampaign.linked',
                'create' => 'campaigns.emailcampaign.create',
                'select' => 'campaigns.emailcampaign.selection',
                'bind_selected' => 'campaigns.emailcampaign.link'
            ],
            'create' => [
                'allow' => true,
                'modal_title' => 'campaigns::campaigns.create_compose_campaign_email',
                'label' => 'campaigns::campaigns.compose_campaign_email',
                'post_create_bind' => [
            ...
            'select' => [
                'allow' => false,
                'modal_title' => 'campaigns::campaigns.email_campaign'
            ],
        ],
