...
class CampaignDatatable extends PlatformDataTable
{
    ...
    public static function availableColumns()
    {
        return [
            ...
            'status' => [
                ...
                'data_type' => 'text',
                'filter_type' => 'text',
                'column_name' => 'campaign_status_id'
            ],
            'type' => [
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->filterColumn('target_audience', function ($query, $keyword) {

            $numbers = DataTableHelper::getNumbersFromFilters($keyword);

            if ($numbers[0] != '' && $numbers[1] != '' ) {
                $query->whereBetween('campaigns.target_audience', array($numbers[0], $numbers[1]));
            }
        });
    ...
    public function query(Campaign $model)
    {
        $query =  $model->with('owner')
            ...
            ->newQuery()->select([
                ...
                'campaigns_dict_status.color as status_color',
