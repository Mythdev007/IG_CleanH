...
class CampaignTypeDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'campaigns.type.show';

    protected $editRoute = 'campaigns.type.edit';
     ...
     */
    public function query(CampaignType $model)
    {
