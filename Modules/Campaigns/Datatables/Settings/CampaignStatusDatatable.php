...
namespace Modules\Campaigns\Datatables\Settings;
...
class CampaignStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'campaigns.status.show';

    protected $editRoute = 'campaigns.status.edit';
     ...
     */
    public function query(CampaignStatus $model)
    {
