...
class PaymentService
{
     ...
     * @return array
     */
    public function incomeVsExpense($currencyDefault = Currency::USD, $lastMonths = 2)
    {

        $currency = Currency::whereCode($currencyDefault)->first();
        ...
        $result = \DB::table('payments')
            ...
            ->where('payments.payment_currency_id', '=', $currency != null ? $currency->id : $currencyDefault)
