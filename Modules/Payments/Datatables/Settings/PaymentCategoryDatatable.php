...
/**
 * Class PaymentCategoryDatatable
 * @package Modules\Payments\Datatables\Settings
 */
class PaymentCategoryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'payments.category.show';

    protected $editRoute = 'payments.category.edit';
