...
/**
 * Class PaymentPaymentMethodDatatable
 * @package Modules\Payments\Datatables\Settings
 */
class PaymentPaymentMethodDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'payments.paymentmethod.show';

    protected $editRoute = 'payments.paymentmethod.edit';
     ...
     */
    public function query(PaymentPaymentMethod $model)
    {
