...
/**
 * Class DocumentStatusDatatable
 * @package Modules\Documents\Datatables\Settings
 */
class DocumentStatusDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'documents.status.show';

    protected $editRoute = 'documents.status.edit';
     ...
     */
    public function query(DocumentStatus $model)
    {
