...
namespace Modules\Documents\Datatables\Settings;
...
/**
 * Class DocumentCategoryDatatable
 * @package Modules\Documents\Datatables\Settings
 */
class DocumentCategoryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'documents.category.show';

    protected $editRoute = 'documents.category.edit';
     ...
     */
    public function query(DocumentCategory $model)
    {
