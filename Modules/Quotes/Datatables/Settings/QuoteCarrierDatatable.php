...
namespace Modules\Quotes\Datatables\Settings;
...
class QuoteCarrierDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'quotes.carrier.show';

    protected $editRoute = 'quotes.carrier.edit';
     ...
     */
    public function query(QuoteCarrier $model)
    {
