...
class QuoteStageDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'quotes.stage.show';

    protected $editRoute = 'quotes.stage.edit';
     ...
     */
    public function query(QuoteStage $model)
    {
