...
namespace Modules\Accounts\Datatables\Settings;
...
class AccountIndustryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'accounts.industry.show';

    protected $editRoute =  'accounts.industry.edit';
     ...
     */
    public function query(AccountIndustry $model)
    {
