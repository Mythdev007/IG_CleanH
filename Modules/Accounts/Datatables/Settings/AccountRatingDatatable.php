...
class AccountRatingDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'accounts.rating.show';

    protected $editRoute = 'accounts.rating.edit';
     ...
     */
    public function query(AccountRating $model)
    {
