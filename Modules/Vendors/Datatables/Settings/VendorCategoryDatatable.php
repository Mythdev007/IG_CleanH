...
namespace Modules\Vendors\Datatables\Settings;
...
class VendorCategoryDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'vendors.category.show';

    protected $editRoute = 'vendors.category.edit';
