...
class VendorDatatable extends PlatformDataTable
{
    ...
    public static function availableColumns()
    {
        return [
            ...
            'country' => [
                ...
                'title' => trans('vendors::vendors.form.country_id'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
            'zip_code' => [
    ...
    public static function availableQueryFilters()
    {
        ...
        return [
            ...
            [
                'id' => 'vendors.country_id',
                'label' => trans('vendors::vendors.form.country_id'),
                'type' => 'integer',
                'input' => 'select',
                'multiple' => true,
                'plugin' => 'select2',
            ...
            [
                ...
                'label' => trans('vendors::vendors.form.continent'),
                'type' => 'string',
                'input' => 'select',
                'multiple' => true,
                'plugin' => 'select2',
    ...
    public function query(Vendor $model)
    {
        $query = $model->newQuery()
            ...
            ->leftJoin('vaance_country', 'vendors.country_id', '=', 'vaance_country.id')
            ->select(
                'vendors.*',
