...
class DealBusinessTypeDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'deals.businesstype.show';

    protected $editRoute =  'deals.businesstype.edit';
     ...
     */
    public function query(DealBusinessType $model)
    {
