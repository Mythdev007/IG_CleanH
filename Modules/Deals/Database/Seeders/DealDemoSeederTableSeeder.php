...
class DealDemoSeederTableSeeder extends SeederHelper
{
    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 50; $i++) {
            ...
            $deal->deal_stage_id = DealStage::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
            $deal->deal_business_type_id = DealBusinessType::where('company_id',$this->firstCompany())->get()->random(1)->first()->id;
        ...
        for ($i = 51; $i <= 100; $i++) {
            ...
            $deal->deal_stage_id = DealStage::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
            $deal->deal_business_type_id = DealBusinessType::where('company_id',$this->secondCompany())->get()->random(1)->first()->id;
