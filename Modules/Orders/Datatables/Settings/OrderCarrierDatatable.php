...
namespace Modules\Orders\Datatables\Settings;
...
class OrderCarrierDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'orders.carrier.show';

    protected $editRoute = 'orders.carrier.edit';
     ...
     */
    public function query(OrderCarrier $model)
    {
