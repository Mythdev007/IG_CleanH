...
Route::group(['middleware' => ['web', 'permission:contacts.browse'], 'prefix' => 'contacts', 'as' => 'contacts.', 'namespace' => 'Modules\Contacts\Http\Controllers'], function () {
    ...
    Route::group(['middleware' => ['web', 'permission:contacts.settings']], function () {
        ...
        Route::resource('language', 'Settings\LanguageController');
        Route::resource('mailinglist', 'Settings\MailingListController');
    });

    Route::resource('contacts', 'ContactsController');

    Route::post('contacts/mass_update', ['as'=>'contacts.mass_update','uses'=> 'ContactsController@massUpdate']);
    ...
    Route::get('contacts/contactwebsites-selection/{entityId}', ['as'=>'contactwebsites.selection','uses'=> 'Tabs\ContactWebsitesController@selection']);
    Route::get('contacts/contactwebsites-linked/{entityId}', ['as'=>'contactwebsites.linked','uses'=> 'Tabs\ContactWebsitesController@linked']);
    Route::post('contacts/contactwebsites-unlink', ['as'=>'contactwebsites.unlink','uses'=> 'Tabs\ContactWebsitesController@unlink']);
    Route::post('contacts/contactwebsites-delete', ['as'=>'contactwebsites.delete','uses'=> 'Tabs\ContactWebsitesController@delete']);
    Route::post('contacts/contactwebsites-link', ['as'=>'contactwebsites.link','uses'=> 'Tabs\ContactWebsitesController@link']);

    Route::get('contacts/contactmailinglists-selection/{entityId}', ['as'=>'contactmailinglists.selection','uses'=> 'Tabs\ContactMailinglistsController@selection']);
    Route::get('contacts/contactmailinglists-linked/{entityId}', ['as'=>'contactmailinglists.linked','uses'=> 'Tabs\ContactMailinglistsController@linked']);
    Route::post('contacts/contactmailinglists-unlink', ['as'=>'contactmailinglists.unlink','uses'=> 'Tabs\ContactMailinglistsController@unlink']);
    Route::post('contacts/contactmailinglists-delete', ['as'=>'contactmailinglists.delete','uses'=> 'Tabs\ContactMailinglistsController@delete']);
    Route::post('contacts/contactmailinglists-link', ['as'=>'contactmailinglists.link','uses'=> 'Tabs\ContactMailinglistsController@link']);

    Route::get('contacts/sentemails-selection/{entityId}', ['as'=>'sentemails.selection','uses'=> 'Tabs\ContactSentEmailsController@selection']);
    Route::get('contacts/sentemails-linked/{entityId}', ['as'=>'sentemails.linked','uses'=> 'Tabs\ContactSentEmailsController@linked']);
    Route::post('contacts/sentemails-unlink', ['as'=>'sentemails.unlink','uses'=> 'Tabs\ContactSentEmailsController@unlink']);
    Route::post('contacts/sentemails-delete', ['as'=>'sentemails.delete','uses'=> 'Tabs\ContactSentEmailsController@delete']);
    Route::post('contacts/sentemails-link', ['as'=>'sentemails.link','uses'=> 'Tabs\ContactSentEmailsController@link']);
    ...
    Route::get('contacts/testimonials-selection/{entityId}', ['as'=>'testimonials.selection','uses'=> 'Tabs\ContactTestimonialsController@selection']);
    Route::get('contacts/testimonials-linked/{entityId}', ['as'=>'testimonials.linked','uses'=> 'Tabs\ContactTestimonialsController@linked']);
    Route::post('contacts/testimonials-unlink', ['as'=>'testimonials.unlink','uses'=> 'Tabs\ContactTestimonialsController@unlink']);
    Route::post('contacts/testimonials-link', ['as'=>'testimonials.link','uses'=> 'Tabs\ContactTestimonialsController@link']);
