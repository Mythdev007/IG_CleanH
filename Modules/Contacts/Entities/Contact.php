...
use Modules\Platform\Settings\Tags\HasTags;
...
{
    use SoftDeletes, HasMorphOwner, LogsActivity, Commentable, HasAttachment, BelongsToTenants, HasTags;
    ...
    protected $dates = ['deleted_at', 'created_at', 'updated_at', 'birth_date'];
    ...
    {
        return $this->belongsTo(CustomerLanguage::class);
    }
