...
class MailingListDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'contacts.mailinglist.show';

    protected $editRoute  = 'contacts.mailinglist.edit';
     ...
     */
    public function query(MailinglistDict $model)
    {
