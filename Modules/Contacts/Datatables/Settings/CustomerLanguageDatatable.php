...
class CustomerLanguageDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'contacts.language.show';

    protected $editRoute  = 'contacts.language.edit';
     ...
     */
    public function query(CustomerLanguage $model)
    {
    ...
    protected function getColumns()
    {
        return
            ...
            [
                ...
                'code' => [
                    'data' => 'code',
                    'title' => trans('contacts::contacts.table.code'),
                    'data_type' => 'text',
                    'filter_type' => 'text'
                ],
