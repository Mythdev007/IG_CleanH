...
class ContactSourceDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'contacts.source.show';

    protected $editRoute  = 'contacts.source.edit';
     ...
     */
    public function query(ContactSource $model)
    {
