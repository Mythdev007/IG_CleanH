...
class ProductDatatable extends PlatformDataTable
{
    ...
    public static function availableQueryFilters()
    {
        return [
            ...
            [
                ...
                'label' => trans('products::products.form.currency_name'),
                'type' => 'string',
            ],
            [
                'id' => 'products.name',
    ...
    public static function availableColumns()
    {
        return [
            ...
            'currency_name' => [
                ...
                'data' => 'currency_name',
                'title' => trans('products::products.form.currency_name'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
            'category' => [
    ...
    public function query(Product $model)
    {
        ...
        $query = $model->newQuery()
            ...
            ->leftJoin('vaance_currency','products.currency_id','=','vaance_currency.id')
            ->select(
                'products.*',
