...
namespace Modules\Products\Datatables\Settings;
...
class ProductTypeDatatable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'products.type.show';

    protected $editRoute = 'products.type.edit';
