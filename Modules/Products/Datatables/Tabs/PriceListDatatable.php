    ...
    public static function availableQueryFilters()
    {
        return [
            ...
            [
                ...
                'label' => trans('products::price_list.form.currency_name'),
                'type' => 'string',
            ],
            [
                'id' => 'price_list.name',
            ...
            [
                'id' => 'price_list.description',
                'label' => trans('products::price_list.form.description'),
                'type' => 'string',
            ],
//            [
    ...
    public static function availableColumns()
    {
        return [
            ...
            'currency_name' => [
                ...
                'data' => 'currency_name',
                'title' => trans('products::price_list.form.currency_name'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
            'product_name' => [
                'name' => 'description',
                'data' => 'description',
                'title' => trans('products::price_list.form.description'),
                'data_type' => 'text',
                'filter_type' => 'text'
            ],
//            'created_at' => [
...
//            ]
    ...
    public function query(PriceList $model)
    {
        ...
        $query = $model->newQuery()
            ...
            ->leftJoin('vaance_currency','price_list.currency_id','=','vaance_currency.id')
            ->select(
                'price_list.*',
