...
class ProductForm extends Form
{
    public function buildForm()
    {
        ...
        $this->add('currency_id', 'select', [
            ...
            'label' => trans('products::products.form.currency_id'),
            'empty_value' => trans('core::core.empty_select')
        ]);

        $this->add('testimonial_group_id', 'select', [
            'choices' => TestimonialProductGroup::all()->pluck('name', 'id')->toArray(),
            'attr' => ['class' => 'select2 pmd-select2 form-control'],
            'label' => trans('products::products.form.testimonial_group_id'),
            'empty_value' => trans('core::core.empty_select')
        ]);
