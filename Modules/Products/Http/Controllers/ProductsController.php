...
class ProductsController extends ModuleCrudController
{
    ...
    protected $relationTabs = [
        ...
        'products_dates' => [
            ...
            'datatable' => [
                'datatable' => ProductDatesDatatable::class
            ],
            'route' => [
                'linked' => 'products.products_dates.linked',
                'create' => 'products.products_dates.create',
                'select' => 'products.products_dates.selection',
                'bind_selected' => 'products.products_dates.link'
            ],
            'create' => [
                'allow' => true,
                'modal_title' => 'products::products_dates.create_new',
                'post_create_bind' => [
                    'relationType' => 'oneToMany',
                    'relatedField' => 'product_id',
                ]
            ...
            'select' => [
                'allow' => false,
                'modal_title' => 'products::products_dates.module'
            ],
        ],
    ];
