...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(\Modules\Platform\Settings\Database\Seeders\MailTemplateSeeder::class);
        ...
        $this->call(\Modules\Platform\Settings\Database\Seeders\CountrySeeder::class);
        $this->call(\Modules\Platform\Settings\Database\Seeders\ProvinceSeeder::class);
        $this->call(\Modules\Platform\Settings\Database\Seeders\SubscriptionCurrencySeeder::class);

        $this->call(\Modules\ContactMailinglists\Database\Seeders\MailinglistDictDatabaseSeeder::class);
    }
}
