...
class CalendarAddFk extends Migration
{
    ...
    public function up()
    {
        Schema::table('vaance_calendar_event', function (Blueprint $table) {
            ...
            $table->foreign('calendar_id')->references('id')->on('vaance_calendar');

            $table->integer('event_priority_id')->unsigned()->nullable()->change();
            $table->foreign('event_priority_id')->references('id')->on('vaance_calendar_dict_event_priority');

            $table->integer('event_status_id')->unsigned()->nullable()->change();
            $table->foreign('event_status_id')->references('id')->on('vaance_calendar_dict_event_status');
        ...
        Schema::table('event_user', function (Blueprint $table) {
            ...
            $table->foreign('event_id')->references('id')->on('vaance_calendar_event')->onDelete('cascade');
        });
    }
