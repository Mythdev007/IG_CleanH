...
(function (root, factory) {
    ...
    var yadcf = (function () {
        ...
        var tablesDT = {},
            ...
            placeholderLang = {
                'select': $.i18n._('select_value'),
                'select_multi': $.i18n._('select_values'),
                'filter': $.i18n._('type_to_filter'),
                'range': [$.i18n._('from'), $.i18n._('to')],
                'date': $.i18n._('select_a_date')
            },
            settingsMap = {};
        ...
        function addDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
            ...
            if(columnObj.filter_type === 'vaance_date_range_picker'){
            ...
            } else if(columnObj.filter_type === 'vaance_date_picker'){ //TODO STILL IN WORK !!!
            ...
            for (columnObjKey in args) {
                if (args.hasOwnProperty(columnObjKey)) {
                    ...
                    if (filter_default_label === undefined) {
                        ...
                        } else if (columnObj.filter_type === "vaance_date_range_picker") {
                            filter_default_label = placeholderLang.date;
                        } else if (columnObj.filter_type === "vaance_date_picker") {
                            filter_default_label = placeholderLang.date;
                        }
	...
	*/
        ...
        function init(oTable, options_arg, params) {
            ...
            if(options_arg[0].data == 'check_select' || options_arg[0].data == 'unlink'){

                for(i = 1; i < options_arg.length; i++){
                    options_arg[i].column_number = i;
                    if(options_arg[i].filter_type != null){
                        newOptions.push(options_arg[i]);
                    }
                }
            }else{
                for(i = 0; i < options_arg.length; i++){
            ...
            switch (filterOptions.filter_type) {
                ...
                case 'multi_select':
                    ...
                    if (filterOptions.filter_type === 'select') {
                        $(filter_selector_string).append("<select class=\"pmd-select2 form-control\" id=\"yadcf-filter-" + table_selector_jq_friendly + '-' + column_number_str + "\" class=\"yadcf-filter\" " +
            ...
            if (isDOMSource(table_arg) || ajaxSource === true) {
                for (j = 0; j < col_filter_arr.length; j++) {
                    ...
                    switch (optionsObj.filter_type) {
                        case 'auto_complete':
                        case 'text':
                        case 'vaance_date_range_picker':
                        case 'vaance_date_picker':
                        case 'date':
