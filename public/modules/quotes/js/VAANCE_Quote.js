var VAANCE_Quote = {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.data.product_id > 0) {
                    ...
                    var row = VAANCE_Quote.tmpProductRow;
    ...
    searchProduct: function () {
        ...
        $(document).on('click', '.search-product', function (e) {
            ...
            VAANCE_Quote.tmpProductRow = current.closest('.quote_row');
        ...
        $(document).on('click', '#RelatedModalTable tbody a', function (e) {
            ...
            if (recordType === 'Modules\\Products\\Entities\\Product') {
                ...
                VAANCE_Quote.loadProduct(recordId);
    ...
    recalculateRows: function () {
        ...
        VAANCE_Quote.recalculateSummary();
    },
    ...
    recalculateSummary: function () {
        ...
        var tax = VAANCE_Quote.calculateTax(subtotal, discount, deliveryCost);

        var summaryGross = VAANCE_Quote.calculateGross(subtotal, deliveryCost, discount, tax);
