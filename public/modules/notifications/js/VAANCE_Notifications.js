            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == 'error') {
                        VAANCE_Common.showNotification('bg-red', result.content);
                    } else {
    ...
    pusherNotificationListener: function () {
        if (window.PUSHER_ACIVE > 0) {
            ...
            channel.bind('Illuminate\\Notifications\\Events\\BroadcastNotificationCreated', function (data) {
                ...
                VAANCE_Notifications.recountNewNotifications();
                VAANCE_Common.showNotification(data.color, data.content, 'top', 'right');
            });
