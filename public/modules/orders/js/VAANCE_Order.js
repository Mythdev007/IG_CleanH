var VAANCE_Order = {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if(result.data.product_id > 0 ){
                    ...
                    var row = VAANCE_Order.tmpProductRow;
    ...
    searchProduct: function(){
        ...
        $(document).on('click','.search-product', function(e){
           ...
           VAANCE_Order.tmpProductRow = current.closest('.order_row');
        ...
        $(document).on('click', '#RelatedModalTable tbody a', function (e) {
            ...
            if(recordType === 'Modules\\Products\\Entities\\Product'){
                ...
                VAANCE_Order.loadProduct(recordId);
    ...
    **/
    recalculateRows: function(){
        ...
        VAANCE_Order.recalculateSummary();
    },
    ...
    recalculateSummary: function(){
        ...
        var tax = VAANCE_Order.calculateTax(subtotal,discount,deliveryCost);

        var summaryGross = VAANCE_Order.calculateGross(subtotal,deliveryCost,discount,tax);
        var balanceDue = VAANCE_Order.calculateBalanceDue(summaryGross,paid);
