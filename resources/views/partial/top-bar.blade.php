    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            @if(config('vaance.global_search'))
                ...
                @if(Auth::user()->hasPermissionTo('company.settings'))
                    <li>
                        <a title="{{ trans('subscription::subscription.billing') }} " href="{{ route('subscription.board') }}">
                                ...
                                <ul class="menu">
                                    <li>
                                        @foreach($tenants as $tenant)
                                            <a href="{{ route('settings.companies.switch-context',$tenant->id) }}"
